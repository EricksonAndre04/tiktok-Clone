...
const App = () => {
  ...
  const videos = [
    ...
    { id: 'video2', url: 'https://www.dropbox.com/scl/fi/ln6dgq8xkex7ms81g3xyn/video-1.mp4?rlkey=1is56o0i5qdn8h1sadfgxj9jf&st=080efura&raw=1' },
    { id: 'video3', url: 'https://www.dropbox.com/scl/fi/uqxi0k7it885ce9qfz2qz/MIDSOMMAR-2019-Midsommar-topfilmsTyE-online-video-cutter.com.mp4?rlkey=f8lp9pen6whtceaibpx4aa03h&st=xk3cuzzs&raw=1' },
    { id: 'video4', url: 'https://www.dropbox.com/scl/fi/s5que95cpfev6n18p8s3h/PSICOSIS-Psycho-1960-de-Alfred-Hitchcock..-psicosis-psycho-online-video-cutter.com.mp4?rlkey=4s1uxceqnqyazv40khbo6awzc&st=8pd2namh&raw=1' },
    { id: 'video5', url: 'https://www.dropbox.com/scl/fi/ntfyz3nlb9k1gxkx8e8w0/R-QUIEM-POR-UN-SUE-O-Requiem-for-a-dream-2000-de-Darren-Aronofsky-online-video-cutter.com.mp4?rlkey=zwpgyjbsh9675d8v3a6pray6p&st=0gamisi1&raw=1' },
    { id: 'video6', url: 'https://www.dropbox.com/scl/fi/cwoxirs82k95kusuzk26z/HIJOS-DE-LOS-HOMBRES-Children-of-men-2006-de-Alfonso-Cuar-n-online-video-cutter.com.mp4?rlkey=wwso9719c98rsxqfhwwwd4e13&st=d8cejjcx&raw=1' },
  ];
    ...
    <div className="app">
      ...
      <div className="main-content">
        ...
        <div className="suggested-users">
          <div className="user">Abuelito</div>
          <div className="user">Johanna De La Cruz</div>
          <div className="user">Mr & Mrs Hart</div>
          <div className="user">Tatiana Ciprian</div>
        </div>
